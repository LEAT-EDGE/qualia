...
intersphinx_mapping = {
    ...
    'qualia_core': ('https://naixtech.unice.fr/~gitlab/docs/qualia-core', None),
    'qualia_plugin_snn': ('https://naixtech.unice.fr/~gitlab/docs/qualia-plugin-snn', None),
    'qualia_plugin_spleat': ('https://naixtech.unice.fr/~gitlab/docs/qualia-plugin-spleat', None),
    'qualia_codegen_core': ('https://naixtech.unice.fr/~gitlab/docs/qualia-codegen-core', None),
    'qualia_codegen_plugin_snn': ('https://naixtech.unice.fr/~gitlab/docs/qualia-codegen-plugin-snn', None),
    'qualia_codegen_plugin_spleat': ('https://naixtech.unice.fr/~gitlab/docs/qualia-codegen-plugin-spleat', None),
}
